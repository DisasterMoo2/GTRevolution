...
public class ImprovedBlastFurnace extends RecipeMapMultiblockController {
    ...
    public ImprovedBlastFurnace(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, RecipeMaps.BLAST_RECIPES);
        this.recipeMapWorkable = new ImprovedLogic(this);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(MetaTileEntityHolder holder) {
        return new ImprovedBlastFurnace(metaTileEntityId);
    }
    ...
    protected class ImprovedLogic extends MultiblockRecipeLogic {

        public ImprovedLogic(RecipeMapMultiblockController tileEntity) {
            super(tileEntity);
        }
