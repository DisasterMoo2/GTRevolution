...
public class IndustrialWiremillInfo extends MultiblockInfoPage {
    ...
    public MultiblockControllerBase getController() {
        return TileEntities.INDUSTRIAL_WIREMILL;
    }
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        MultiblockShapeInfo shapeInfo = MultiblockShapeInfo.builder()
            ...
            .aisle("XXX", "C#E", "XXX")
            .aisle("XXX", "XIX", "XXX")
            .where('C', TileEntities.INDUSTRIAL_WIREMILL, EnumFacing.WEST)
            .where('X', MetaBlocks.MULTIBLOCK_CASING.getState(MultiblockCasing.CasingType.WIRE_CASING))
